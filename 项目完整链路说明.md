...
- `phone-sms/providers/hero-sms.js` / `phone-sms/providers/five-sim.js` / `phone-sms/providers/nexsms.js`
  承接已模块化的接码平台协议适配；HeroSMS / 5sim / NexSMS 的 provider id、UI 顺序和能力入口统一走注册表，NexSMS 的取号与查码主流程仍由 `background/phone-verification-flow.js` 承接。
