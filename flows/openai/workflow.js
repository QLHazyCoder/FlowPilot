(function attachMultiPageOpenAiWorkflow(root, factory) {
  ...
  "normal": [
    ...
    },
    {
      ...
      "order": 30,
      "key": "fill-password",
      "title": "Enter password and continue",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
    ...
    },
    {
      ...
      "title": "Get signup verification code",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
    ...
    },
    {
      ...
      "order": 50,
      "key": "fill-profile",
      "title": "Fill in name and birthday",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
    ...
    },
    {
      ...
      "order": 70,
      "key": "oauth-login",
      "title": "Refresh OAuth and log in",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
      "command": "oauth-login",
      "flowId": "openai"
    },
    {
      ...
      "title": "Get login verification code",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
      "command": "submit-verification-code",
    ...
    },
    {
      ...
      "order": 110,
      "key": "platform-verify",
      "title": "Platform callback verification",
  ...
  "normalPhone": [
    ...
    },
    {
      ...
      "order": 20,
      "key": "submit-signup-email",
      "title": "Sign up and enter phone number",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
      "command": "submit-signup-email",
      "flowId": "openai"
    ...
    },
    {
      ...
      "title": "Get email binding verification code",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
  ...
  "normalPhoneRelogin": [
    ...
    },
    {
      ...
      "title": "Refresh OAuth and log in after email binding (email)",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
      "command": "oauth-login",
      "flowId": "openai"
    },
    {
      ...
      "title": "Get login verification code (email)",
      "sourceId": "openai-auth",
      "driverId": "flows/openai/content/openai-auth",
      "command": "submit-verification-code",
      "mailRuleId": "openai-login-code",
  ...
  "plusPaypal": [
    ...
    },
    {
      ...
      "title": "Fill billing details and submit order",
      "sourceId": "plus-checkout",
      "driverId": "flows/openai/content/plus-checkout",
    ...
    },
    {
      ...
      "order": 80,
      "key": "paypal-approve",
      "title": "PayPal login and authorization",
    ...
    },
    {
      ...
      "title": "Confirm subscription return",
      "sourceId": "plus-checkout",
      "driverId": "flows/openai/content/plus-checkout",
  ...
  "plusPaypalSub2apiSession": [
    ...
    },
    {
      ...
      "title": "Import current ChatGPT session to SUB2API",
  ...
  "plusPaypalCpaSession": [
    ...
    },
    {
      ...
      "title": "Import current ChatGPT session to CPA",
      "sourceId": "vps-panel",
  ...
  "plusPaypalHosted": [
    ...
    },
    {
      ...
      "title": "No-card direct bind: enter PayPal email",
      "sourceId": "paypal-flow",
      "driverId": "flows/openai/content/paypal-flow",
    ...
    },
    {
      ...
      "title": "No-card direct bind: fill PayPal details",
      "sourceId": "paypal-flow",
      "driverId": "flows/openai/content/paypal-flow",
    ...
    },
    {
      ...
      "title": "No-card direct bind: confirm PayPal creation",
      "sourceId": "paypal-flow",
      "driverId": "flows/openai/content/paypal-flow",
    ...
    },
    {
      ...
      "title": "No-card direct bind: complete PayPal authorization",
      "sourceId": "paypal-flow",
      "driverId": "flows/openai/content/paypal-flow",
  ...
  "plusGopay": [
    ...
    },
    {
      ...
      "order": 60,
      "key": "plus-checkout-create",
      "title": "Open GoPay subscription page",
      "sourceId": "plus-checkout",
      "driverId": "flows/openai/content/plus-checkout",
      "command": "plus-checkout-create",
      "flowId": "openai"
    },
    {
      ...
      "title": "Wait for GoPay subscription confirmation",
      "sourceId": "gopay-flow",
  ...
  "plusGpc": [
    ...
    },
    {
      ...
      "order": 70,
      "key": "plus-checkout-billing",
      "title": "Wait for GPC task completion",
      "sourceId": "plus-checkout",
      "driverId": "flows/openai/content/plus-checkout",
      "command": "plus-checkout-billing",
      "flowId": "openai"
